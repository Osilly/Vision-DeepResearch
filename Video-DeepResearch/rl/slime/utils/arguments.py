    ...
    def add_slime_arguments(parser):
        ...
        def add_eval_arguments(parser):
            ...
            parser.add_argument(
                ...
                default=None,
                help=(
                    "Directory to dump per-eval-rollout jsonl traces. "
                    "When set, each evaluation rollout writes one jsonl file named with rollout id and computed step."
                ),
            )
        ...
        def add_algo_arguments(parser):
            ...
            parser.add_argument(
                ...
                type=int,
                default=0,
                help="Number of teacher top-k logits used by logits-level distillation custom losses.",
            )
            parser.add_argument(
                "--kl-loss-type",
                type=str,
