...
class Sample:
    ...
    teacher_topk_log_probs: list[list[float]] | None = None  # Teacher top-k log probabilities for logits-level OPD
    teacher_topk_indices: list[list[int]] | None = None  # Teacher top-k token ids for logits-level OPD
