"""
Search tool for Vision-DeepResearch multi-turn tool-calling rollout.

Based on vision_deepresearch_async_workflow/tools/search_tool.py
"""
...
class SearchTool(DeepResearchTool):
    ...
    async def _zhipu_search(self, query: str | list) -> str:
        ...
        async def search_single_query(q: str) -> str:
            ...
            try:
                resp = await run_with_retries_async(send_request, executor=self.executor)
