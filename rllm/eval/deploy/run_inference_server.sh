#!/bin/bash
# Inference server — the policy that produces tool calls and final answers.
# Point TONGYI_BASE_URL at this endpoint.
#
# Env overrides:
#   MODEL_PATH      local path or HF id of the VL model
#   MODEL_NAME      served-model-name (must match TONGYI_MODEL_NAME)
